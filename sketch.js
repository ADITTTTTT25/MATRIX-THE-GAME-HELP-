...
function setup() {
  ...
  //class object
  game = new Game();
  bckground = new Background(displayWidth / 6, displayHeight / 3.7);
  bckground2 = new Background(displayWidth / 2, displayHeight / 3.7);
  bckground3 = new Background(displayWidth / 1.2, displayHeight / 3.7);
  bckground4 = new Background(displayWidth / 6, displayHeight / 1.3);
  bckground5 = new Background(displayWidth / 2, displayHeight / 1.3);
  bckground6 = new Background(displayWidth / 1.2, displayHeight / 1.3);
